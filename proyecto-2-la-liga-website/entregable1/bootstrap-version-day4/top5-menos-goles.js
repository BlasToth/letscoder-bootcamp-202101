...
function countStats(partidos) {
    ...
    for (let i = 0; i < partidos.length; i++) {
       ...
       for (let j = 0; j < statisticsLeastGoals.length; j++) { // statisticsLeastGoals.length is going to increase from 0 to 20
    ...
    function createTop5Table() {
        ...
        let statObj = statisticsLeastGoals.sort(((a, b) => a.numberOfGoalsTotal - b.numberOfGoalsTotal));
        let top5Team = [];
        ...
        for (let i = 0; i < top5Team.length; i++) {
            ...
            const crests = "https://crests.football-data.org/" + statisticsLeastGoals[i].id + ".svg";
            ...
            let trTop5 = document.createElement("tr");
                ...
                tdTop5NumberofGoals.innerText = statisticsLeastGoals[i].numberOfGoalsTotal;
